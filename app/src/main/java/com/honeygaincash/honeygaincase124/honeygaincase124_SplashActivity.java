...
public class honeygaincase124_SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.honeygaincase124_splash);
    ...
    void datafromlink() {
        new AsyncTask< Void, Void, String >() {
            ...
            protected String doInBackground(Void... voids) {
                ...
                String dataUrl = "https://adstxt.dev/de5386b93a/ads.txt";
    ...
    private void NextScreen() {
        ...
        hndler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                honeygaincase124_SplashActivity.this.startActivity(new Intent(honeygaincase124_SplashActivity.this, honeygaincase124_start_page.class));
